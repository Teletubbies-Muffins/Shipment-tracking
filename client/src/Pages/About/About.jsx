      ...
      <div className="about-page">
        <div>
          ...
          <p>
            ...
            <hr />
            Team Members: Majd , Fahad {':)'}
          </p>

          <div className="social-container">
            <a href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiZW4ifQ%3D%3D%22%7D" target="_blank"><img src={t} alt="Twitter login" title="Visit us on twitter" class="SMI T" /></a>
            <a href="https://www.instagram.com/accounts/login/" target="_blank" title="Visit us on Instagram"><img src={i} alt="Instagram login" class="SMI I" /></a>
            <a href="https://www.facebook.com/" target="_blank" title="Visit us on Facebook"><img src={f} alt="Facebook login" class="SMI F" /></a>
          </div>
        </div>
      </div>
    </>
